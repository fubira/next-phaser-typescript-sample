...
export class Dialog extends Phaser.GameObjects.Container {
  ...
  constructor(
    ...
    const buttonColor = Phaser.Display.Color.ValueToColor(PixelUI.theme.styles.colorMain || 0);
    ...
    const dialog = new ComponentBase(scene, 0, -buttonHeight / 2, [titleLabel, messageLabel, ...buttons], {
