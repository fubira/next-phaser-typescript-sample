...
export class ToggleButton extends ComponentBase {
  ...
  constructor(
    ...
    const textColor = Phaser.Display.Color.ValueToColor(style?.color || PixelUI.theme.textColor());
...
export function ToggleButtonFactory(
  ...
  const button = new ToggleButton(scene, x, y, text, onToggle, toggle, style || {});
